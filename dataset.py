...
class ShapesDataset(Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, yaml_floder):
        self.add_class("shapes", 1, "crooked")
        self.add_class("shapes", 2, "wear")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("crooked")!=-1:
                labels_form.append("crooked")
            elif labels[i].find("wear")!=-1:
                labels_form.append("wear")
